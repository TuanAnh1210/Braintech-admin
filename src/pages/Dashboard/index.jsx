                    ...
                    <div className='lg:w-[190px] xl:w-[280px] sm:w-[80px] md:w-[100px] relative px-[5px] py-[10px]'>
                        <div className=' static   '>
                            <div className='bg-[#f5700c] absolute top-0 left-0 sm:w-[40px] sm:h-[60px] md:h-[75px] md:w-[50px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] text-center sm:pl-[15px] lg:pl-[25px] p-[25px] rounded '>
                                <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[15px] sm:h-[15px] md:w-[20px] md:h-[20px] lg:w-[36px] lg:h-[36px]" width='' height='' fill='white' class='bi bi-people-fill' viewBox='0 0 16 16'>
                        ...
                        <div className='bg-gray-600 h-[100%] mt-[20px] pt-[50px] pb-[10px] rounded w-full'>
                            ...
                            <div className='mt-[30px] mx-[20px]  border-t-2 border-white  '>
                                <div className=' flex flex-row pt-[10px] text-center items-center'>
                                    <svg xmlns='http://www.w3.org/2000/svg' className="" height='16' width='16' viewBox='0 0 640 512' fill='white'><path d='M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z' /></svg>
                                    <a href='#pablo' className='warning-link  text-white sm:text-[10px] lg:text-[15px]'>Tổng học viên</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='lg:w-[190px] xl:w-[280px] sm:w-[80px] md:w-[100px] relative p-[5px] py-[10px] '>
                        <div className='static '>
                            <div className='card-icon bg-[#288c6c] absolute top-0 left-0  sm:w-[40px] md:w-[40px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] text-center sm:pl-[15px] lg:pl-[25px] p-[25px] rounded '>
                                <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[15px] sm:h-[15px] md:w-[20px] md:h-[20px] lg:w-[36px] lg:h-[36px]" width='' height='' fill='white' class='bi bi-code' viewBox='0 0 16 16'>
                        ...
                        <div className='bg-gray-600 h-[100%] mt-[20px] pt-[50px] pb-[10px]  rounded w-full'>
                            ...
                            <div className='mt-[30px] mx-[20px]  border-t-2 border-white  '>
                                <div className=' flex flex-row pt-[10px] text-center items-center'>
                                    <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[0px] sm:h-[0px]" width='16' height='16' fill='white' class='bi bi-clipboard-fill' viewBox='0 0 16 16'>
                                        <path fill-rule='evenodd' d='M10 1.5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5zm-5 0A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5v1A1.5 1.5 0 0 1 9.5 4h-3A1.5 1.5 0 0 1 5 2.5zm-2 0h1v1A2.5 2.5 0 0 0 6.5 5h3A2.5 2.5 0 0 0 12 2.5v-1h1a2 2 0 0 1 2 2V14a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V3.5a2 2 0 0 1 2-2' />
                                    </svg>
                                    <a href='#pablo' className='warning-link  text-white sm:text-[10px] lg:text-[15px]'>Tổng khóa học</a>
                                </div>
                            </div>
                    ...
                    <div className=' lg:w-[190px] xl:w-[280px] sm:w-[80px] md:w-[100px] relative p-[5px] py-[10px] '>
                        <div className=' static   '>
                            <div className='bg-[#d22824] absolute top-0 left-0 sm:w-[40px] md:w-[40px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] text-center sm:pl-[15px] lg:pl-[25px] p-[25px] rounded '>
                                <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[15px] sm:h-[15px] md:w-[20px] md:h-[20px] lg:w-[36px] lg:h-[36px]" width='' height='' fill='white' class='bi bi-braces' viewBox='0 0 16 16'>
                    ...
                    <div className='lg:w-[190px] xl:w-[280px] sm:w-[80px] md:w-[100px] relative p-[5px] py-[10px] '>
                        <div className='static'>
                            <div className='bg-[#029eb1] absolute top-0 left-0 sm:w-[40px] md:w-[40px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] sm:pl-[15px] lg:pl-[25px] p-[25px] rounded '>
                                <svg xmlns="http://www.w3.org/2000/svg" className="sm:w-[15px] sm:h-[15px] md:w-[20px] md:h-[20px] lg:w-[36px] lg:h-[36px]" width="" height="" fill="white" class="bi bi-file-code" viewBox="0 0 16 16">
