        ...
        <div className="w-full">
            ...
            <Row className="pr-[30px] w-[100%] ">
                <Col className="gutter-row " span={6}>
                    <div className='lg:w-[190px] xl:w-[280px] sm:w-[50px] md:w-[100px] relative px-[5px] py-[10px]'>
                        <div className=' static   '>
                            <div className='bg-[#f5700c] absolute top-0 left-0 sm:w-[40px] sm:h-[60px] md:h-[75px] md:w-[50px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] text-center ml-[20px] p-[25px] rounded '>
                                <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[10px] sm:h-[10px] md:w-[20px] md:h-[20px] lg:w-[36px] lg:h-[36px]" width='' height='' fill='white' class='bi bi-people-fill' viewBox='0 0 16 16'>
                                    <path d='M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5' />
                                </svg>
                            </div>
                        </div>
                        <div className='bg-gray-600 h-[100%] mt-[20px] pt-[50px] pb-[10px] rounded w-full'>
                            <div className='lg:ml-[65%] xl:ml-[65%] sm:ml-[50%]'>
                                <p className='text-white sm:text-[10px] md:text-[10px] lg:text-[17px] xl:text-[17px]'>Học viên</p>
                                <h3 className='text-white xl:ml-[65%] lg:ml-[60%] sm:ml-[50%] lg:text-[17px]'>
                                    {listUser?.data
                            ...
                            <div className='mt-[30px] mx-[20px]  border-t-2 border-white  '>
                                <div className=' flex flex-row pt-[10px] text-center items-center'>
                                    ...
                                    <a href='#pablo' className='warning-link ml-[10px] text-white sm:text-[10px] lg:text-[15px]'>Tổng học viên</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <Col className="gutter-row" span={6}>
                    <div className='lg:w-[190px] xl:w-[280px] sm:w-[50px] md:w-[100px] relative p-[5px] py-[10px] '>
                        <div className='static '>
                            <div className='card-icon bg-[#288c6c] absolute top-0 left-0  sm:w-[40px] md:w-[40px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] text-center ml-[20px] p-[25px] rounded '>
                                <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[10px] sm:h-[10px] md:w-[20px] md:h-[20px] lg:w-[36px] lg:h-[36px]" width='' height='' fill='white' class='bi bi-code' viewBox='0 0 16 16'>
                        ...
                        <div className='bg-gray-600 h-[100%] mt-[20px] pt-[50px] pb-[10px]  rounded w-full'>
                            ...
                            <div className='mt-[30px] mx-[20px]  border-t-2 border-white '>
                                <div className=' flex pt-[10px] items-center'>
                                    ...
                                    <a href='#pablo' className='warning-link ml-[10px] text-white sm:text-[10px] lg:text-[15px]'>Tổng khóa học</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <Col className="gutter-row" span={6}>
                    <div className=' lg:w-[190px] xl:w-[280px] sm:w-[50px] md:w-[100px] relative p-[5px] py-[10px] '>
                        <div className=' static   '>
                            <div className='bg-[#d22824] absolute top-0 left-0 sm:w-[40px] md:w-[40px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] text-center ml-[20px] p-[25px] rounded '>
                                <svg xmlns='http://www.w3.org/2000/svg' className="sm:w-[10px] sm:h-[10px] md:w-[25px] md:h-[25px] lg:w-[36px] lg:h-[36px]" width='' height='' fill='white' class='bi bi-braces' viewBox='0 0 16 16'>
                ...
                <Col className="gutter-row " span={6}>
                    <div className='lg:w-[190px] xl:w-[280px] sm:w-[50px] md:w-[100px] relative p-[5px] py-[10px] '>
                        <div className='static'>
                            <div className='bg-[#029eb1] absolute top-0 left-0 sm:w-[40px] md:w-[40px] lg:w-[86px] lg:h-[86px]  sm:ml-[15px] lg:ml-[20px] sm:p-[20px] lg:p-[25px] rounded '>
                                <svg xmlns="http://www.w3.org/2000/svg" className="sm:w-[10px] sm:h-[10px] md:w-[25px] md:h-[25px] lg:w-[36px] lg:h-[36px]" width="" height="" fill="white" class="bi bi-file-code" viewBox="0 0 16 16">
            ...
            <div className=' relative p-[5px] mt-[100px] '>
                <div className='static'>
                    <div className='bg-gray-600 absolute top-0 left-0  w-[95%] sm:h-32 md:h-32 h-[105px] ml-[30px] p-[15px] rounded '>
                        <h4 className='text-white xl:text-[25px] lg:text-[25px] sm:text-[18px] md:text-[18px] mt-[10px] mb-[5px]'>Doanh thu năm 2024</h4>
                        <p className='text-white pb-[20px] mr-[20px] sm:text-[15px] md:text-[15px] text-[18px]'> Tổng doanh thu: <span className="px-[5px] font-bold">{VND.format(sumItem)}</span></p>
                    </div>
                </div>
